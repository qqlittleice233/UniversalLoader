...
fun Class<*>.hookMethod(methodName: String, vararg args: Any?) = try {
    ...
    if (clazzArgs.isNotEmpty() and clazzArgs.all { (it == null) or (it !is Class<*>) }) throw IllegalArgumentException(
        "The arguments must be Class<?> or not null"
    )
    val method = declaredMethods.firstOrNull { method ->
        (method.name == methodName) and (method.parameterCount == clazzArgs.size) and (method.parameterTypes.zip(
            clazzArgs
        ).all { (type, arg) -> type == arg })
    }
...
fun <T : Executable> Executable.hook(hooker: BridgeApi.Hooker<T>) = try {
    when (this) {
        ...
        is Constructor<*> -> UniversalBridge.get()
            .hook(this, hooker as BridgeApi.Hooker<Constructor<*>>)
...
inline fun <T : Executable> Executable.replace(crossinline hooker: (BridgeApi.BeforeMethodInvokedCallback<T>) -> Any?) =
    try {
        when (this) {
            is Method -> UniversalBridge.get().hook(this, object : BridgeApi.Hooker<Method> {
                override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Method>) {
                    ...
                    }.onSuccess { callback.returnAndSkip(it) }
            ...
            is Constructor<*> -> UniversalBridge.get()
                .hook(this, object : BridgeApi.Hooker<Constructor<*>> {
...
inline fun <T : Executable> Executable.hookBefore(crossinline hooker: (BridgeApi.BeforeMethodInvokedCallback<T>) -> Unit) =
    try {
        when (this) {
            is Method -> UniversalBridge.get().hook(this, object : BridgeApi.Hooker<Method> {
                override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Method>) {
...
inline fun <T : Executable> Executable.hookAfter(crossinline hooker: (BridgeApi.AfterMethodInvokedCallback<T>) -> Unit) =
    try {
        when (this) {
            is Method -> UniversalBridge.get().hook(this, object : BridgeApi.Hooker<Method> {
                override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Method>) {}
...
inline fun Class<*>.hookBeforeMethod(
    methodName: String,
    vararg args: Class<*>,
    crossinline hooker: (BridgeApi.BeforeMethodInvokedCallback<Method>) -> Unit
) = try {
...
inline fun Class<*>.hookAfterMethod(
    methodName: String,
    vararg args: Class<*>,
    crossinline hooker: (BridgeApi.AfterMethodInvokedCallback<Method>) -> Unit
) = try {
    hookMethod(methodName, *args, object : BridgeApi.Hooker<Method> {
        override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Method>) {}
        override fun afterMethodInvoked(callback: BridgeApi.AfterMethodInvokedCallback<Method>) {
...
inline fun Class<*>.replaceMethod(
    methodName: String,
    vararg args: Class<*>,
    crossinline hooker: (BridgeApi.BeforeMethodInvokedCallback<Method>) -> Any?
) = try {
    hookMethod(methodName, *args, object : BridgeApi.Hooker<Method> {
        override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Method>) {
            runCatching {
...
inline fun Class<*>.replaceAllMethods(
    methodName: String,
    crossinline hooker: (BridgeApi.BeforeMethodInvokedCallback<Method>) -> Any?
) = try {
    UniversalBridge.get().hookAllMethods(this, methodName, object : BridgeApi.Hooker<Method> {
...
fun Class<*>.hookConstructor(vararg args: Any?) = try {
    ...
    val constructor = declaredConstructors.firstOrNull { constructor ->
        (constructor.parameterCount == clazzArgs.size) and (constructor.parameterTypes.zip(clazzArgs)
            .all { (type, arg) -> type == arg })
    }
...
inline fun Class<*>.hookBeforeConstructor(
    vararg args: Class<*>,
    crossinline hook: (BridgeApi.BeforeMethodInvokedCallback<Constructor<*>>) -> Unit
) = try {
...
inline fun Class<*>.hookAfterConstructor(
    vararg args: Class<*>,
    crossinline hook: (BridgeApi.AfterMethodInvokedCallback<Constructor<*>>) -> Unit
) = try {
    hookConstructor(*args, object : BridgeApi.Hooker<Constructor<*>> {
        override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Constructor<*>>) {}
        override fun afterMethodInvoked(callback: BridgeApi.AfterMethodInvokedCallback<Constructor<*>>) {
...
inline fun Class<*>.replaceConstructor(
    vararg args: Class<*>,
    crossinline hook: (BridgeApi.BeforeMethodInvokedCallback<Constructor<*>>) -> Any?
) = try {
    hookConstructor(*args, object : BridgeApi.Hooker<Constructor<*>> {
        override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Constructor<*>>) {
            runCatching {
...
inline fun Class<*>.hookBeforeAllConstructor(crossinline hook: (BridgeApi.BeforeMethodInvokedCallback<Constructor<*>>) -> Unit) =
    try {
...
inline fun Class<*>.hookAfterAllConstructor(crossinline hook: (BridgeApi.AfterMethodInvokedCallback<Constructor<*>>) -> Unit) =
    try {
        UniversalBridge.get().hookAllConstructors(this, object : BridgeApi.Hooker<Constructor<*>> {
            override fun beforeMethodInvoked(callback: BridgeApi.BeforeMethodInvokedCallback<Constructor<*>>) {}
            override fun afterMethodInvoked(callback: BridgeApi.AfterMethodInvokedCallback<Constructor<*>>) {
...
fun String.hookBeforeMethod(
    ...
    methodName: String,
    vararg args: Class<*>,
    hooker: (BridgeApi.BeforeMethodInvokedCallback<Method>) -> Unit
) = try {
    val clazz = classLoader.loadClass(this)
...
fun String.hookAfterMethod(
    ...
    methodName: String,
    vararg args: Class<*>,
    hooker: (BridgeApi.AfterMethodInvokedCallback<Method>) -> Unit
) = try {
    val clazz = classLoader.loadClass(this)
...
fun String.replaceMethod(
    ...
    methodName: String,
    vararg args: Class<*>,
    hooker: (BridgeApi.BeforeMethodInvokedCallback<Method>) -> Any?
) = try {
    val clazz = classLoader.loadClass(this)
...
fun <T : Any> BridgeApi.HookerCallback<Constructor<*>>.invokeOriginal() {
    UniversalBridge.get()
        .invokeOriginal(getExecutable() as Constructor<T>, getThisObject() as T, getArgs())
}